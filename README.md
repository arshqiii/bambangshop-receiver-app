...
1. In this tutorial, we used RwLock<> to synchronise the use of Vec of Notifications. Explain why it is necessary for this case, and explain why we do not use Mutex<> instead?
    ...
    > Penggunaan RwLock<> lebih cocok dalam kasus ini karena RwLock<> dapat memungkinkan banyak thread untuk membaca data secara bersamaan tanpa harus menunggu thread sebelumnya selesai. Sedangkan penggunaan Mutex<> tidak cocok karena hanya memungkinkan satu thread mengakses data dalam satu waktu baik untuk read maupun write, yang kurang efisien jika operasi baca jauh lebih sering daripada operasi tulis.
...
3. Have you tried to make your own Tests, or enhance documentation on your Postman collection? If you have tried those features, tell us whether it is useful for your work (it can be your tutorial work or your Group Project).
    ...
    > Belum sempat, namun membuat test akan sangat berguna untuk memastikan sistem berjalan dengan baik ketika pengembangan proyek grup. Dengan tests, kita bisa memverifikasi respons, status kode, dan data yang dikembalikan tanpa perlu mengecek secara manual. Ini mempercepat debugging, meningkatkan keandalan sistem, dan mempermudah regresi testing saat ada perubahan kode. Ditambah dengan dokumentasi di Postman yang dapat membantu kita memahami cara menggunakan API dengan jelas serta dapat berbagi Collections yang telah dibuat antar sesama anggota kelompok lainnya sehingga membantu dalam kolaborasi kelompok.